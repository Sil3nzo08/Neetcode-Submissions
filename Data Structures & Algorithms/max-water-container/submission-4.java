...
Key takeways:
    - Two pointer solution is goated here. We start with lp at the very left, and rp at the very right to
      ...
      is still 8. Order doesn't matter here. Interestingly, that area is the biggest of all the 
      permutations inside the 8-8 border, provided no more than 1 height is greater than 8 here.
      In cases where two or more heights in between are greater than 8, well the algorithm will ensure to
      consider them.  
*/
