class Solution {
    public int[] productExceptSelf(int[] nums) {
        ...
        int[] suffix = new int[nums.length]; // Multiplication of all numbers in 'nums' to the right + that one
        int[] prefix = new int[nums.length]; // Multiplication of all numbers in 'nums' to the left + that one
